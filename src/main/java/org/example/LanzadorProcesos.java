...
public class LanzadorProcesos {
    public static void main(String[] args) {
        ...
        //1. ProcessBuilder es el puente entre Java y el Sistema Operatio
        // Preparamos el comando (en Windows, notepad.ext es el block de notas).
        ...
        try {
            ...
            System.out.println("Error: El proceso fue interrumpido brucamente");
        }
